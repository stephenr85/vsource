...
$('.rssincl-entry').not(':has(.rssincl-itemimage)').prepend( "<div class='rssincl-itemimage'><img src='http://vesnaus.com/vsource/images/veolianewslogo.png' ></div>" ); 
...
$(document).on('submit','#signinform', function(e){
	...
	$.post('http://vesnaus.com/vsource/signin.php', regdetails, function(data){
	if (data == 0) {
...
$(document).on('submit','#userreg', function(e){
	...
	$.post('http://vesnaus.com/vsource/userregistration.php', regdetails, function(data){
...
$(document).on('click','#validationbutton', function(e){
	...
	$.post('http://vesnaus.com/vsource/validatecode.php', regdetails, function(data){
...
$(document).on('click','#newpassword', function(e){
	...
	$.post('http://vesnaus.com/vsource/resetpassword.php', regdetails, function(data){
...
$(document).on('click','#newpasscodebutton', function(e){
	...
	$.post('http://vesnaus.com/vsource/newpassword.php', regdetails, function(data){
...
$(document).on('click','#shareideabutton', function(e){
	...
	$.post('http://vesnaus.com/vsource/shareidea.php', regdetails, function(data){
	if (data == 0) {
		$('#myModal').modal('show');
	}
...
$(document).on('click','#feedbacksubmit', function(e){
	...
	$.post('http://vesnaus.com/vsource/providefeedback.php', regdetails, function(data){
	if (data == 0) {
