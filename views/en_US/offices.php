...
<div class="bh-sl-form-container">
						<form id="bh-sl-user-location" class="form-inline" data-ajax="false" method="post" role="form">
							<div class="form-input form-group">
								...
								<input type="text" class="ui-input-search form-control" id="bh-sl-address" name="bh-sl-address" placeholder="<?php echo t('enter address or zip code') ?>" /></div>	</div>
							</div>
</form>
					</div>
	</div><!-- /header -->
	...
	<div class="suggestions"><strong><?php echo t('Suggestions by Location') ?></strong></div>
